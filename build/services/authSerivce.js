...
exports.verifyUser = exports.signChurchToken = void 0;
const jsonwebtoken_1 = __importDefault(require("jsonwebtoken"));
const church_1 = require("../modules/church");
const secret = 'Tea, Earl Grey, Hot';
const signChurchToken = async (church) => {
    let token = jsonwebtoken_1.default.sign({ churchId: church.churchId }, secret, { expiresIn: '1hr' });
    return token;
};
exports.signChurchToken = signChurchToken;
